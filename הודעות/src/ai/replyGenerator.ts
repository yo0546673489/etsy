...
Write a suitable reply in language: ${settings.language}
`;
...
Rating: ${'⭐'.repeat(reviewRating)} (${reviewRating}/5)
${productName ? `Product: ${productName}` : ''}
Content: "${reviewText}"

Write a suitable shop reply in language: ${settings.language}
`;
